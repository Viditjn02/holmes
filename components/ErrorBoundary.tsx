      ...
      return (
        <div className="grid h-full place-items-center p-8">
          <div className="max-w-xs text-center">
            <span className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl border border-line bg-panel text-white/40">
            ...
            <button
              onClick={this.reset}
              className="mt-4 rounded-lg border border-line bg-panel/70 px-3 py-1.5 text-[12px] text-white/70 transition-colors hover:border-accent/40 hover:text-white"
            >
              Retry
            </button>
          </div>
